  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        color: '#d0d0d8', lineHeight: '1.8', textTransform: 'lowercase',
        letterSpacing: entry.category === 'cita' ? '0.5px' : '0px',
      }}>
        {entry.category === 'cita' && (
          <span style={{
      ...
      {entry.expansion && (
        <div style={{ marginTop: '14px' }}>
          <button onClick={() => setShowExp(!showExp)} style={{
            ...s.btn, borderColor: `${accent}22`, color: `${accent}99`,
            fontSize: '9px',
          }}>
          ...
          {showExp && (
            <div style={{
              marginTop: '12px', padding: '14px', background: '#08080e',
              borderLeft: `1px solid ${accent}15`, ...s.mono,
      ...
      {!entry.expansion && (
        <button
          ...
          style={{
            ...s.btn, marginTop: '12px', fontSize: '9px',
            borderStyle: 'dashed', borderColor: '#1a1a2a', color: '#3a3a4a',
          }}
        >
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          ...s.jet, fontSize: '9px', color: `${accent}88`,
          letterSpacing: '1.5px',
        }}>{cat.icon} {cat.label}</span>
        <span style={{ ...s.jet, fontSize: '9px', color: '#2a2a2a' }}>
      ...
      <div style={{ maxWidth: '560px', textAlign: 'center', zIndex: 2 }}>
        ...
        {entry.expansion && (
          <div style={{ marginTop: '28px' }}>
            <button onClick={() => setShowExp(!showExp)} style={{
              ...s.btn, borderColor: `${accent}22`, color: `${accent}88`,
            }}>
      ...
      {/* nav arrows */}
      <div style={{
        position: 'absolute', bottom: '24px', display: 'flex', gap: '16px', zIndex: 2,
      }}>
        <button
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
            {filtered.length > 0 && (
              <button onClick={() => setView('slides')} style={{
                ...s.btn, fontSize: '9px',
              }}>▶ slides</button>
            )}
            <button
        ...
        <div style={{
          ...
          <span style={{
            ...s.jet, fontSize: '9px', color: getAuthorColor(user),
            letterSpacing: '1.5px',
          }}>
            ⊕ {user}
          </span>
          <button onClick={handleLogout} style={{
            ...s.btn, fontSize: '8px', padding: '2px 8px',
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        {loading ? (
          ...
          <div style={{ padding: '60px 20px', textAlign: 'center' }}>
            <div style={{
              fontSize: '32px', color: '#1a1a2a', marginBottom: '12px',
            }}>◇</div>
